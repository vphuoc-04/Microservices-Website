package com.example.user_catalogue_service.configs;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http, JwtAuthFilter jwtAuthFilter) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                .requestMatchers(
                    "/api/v1/user-catalogue/get_all_catalogue",
                    "/api/v1/user-catalogue/create_catalogue",
                    "/api/v1/user-catalogue/update_catalogue/{id}",
                    "/api/v1/user-catalogue/delete_catalogue/{id}"
                ).permitAll()
